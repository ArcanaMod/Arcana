...
public class TaintedLargeOakGenerator extends AbstractTreeFeature{
	...
	public TaintedLargeOakGenerator(boolean notify, boolean untainted){
		...
		leavesBlock = untainted ? ArcanaBlocks.UNTAINTED_OAK_LEAVES : ArcanaBlocks.TAINTED_OAK_LEAVES;
		logBlock = untainted ? ArcanaBlocks.UNTAINTED_OAK_LOG : ArcanaBlocks.TAINTED_OAK_LOG;
		saplingBlock = untainted ? ArcanaBlocks.UNTAINTED_OAK_SAPLING : ArcanaBlocks.TAINTED_OAK_SAPLING;
	}
	...
	void limb(BlockPos limbPos, BlockPos trunkPos, Block logBlock){
		BlockPos blockpos = trunkPos.add(-limbPos.getX(), -limbPos.getY(), -limbPos.getZ());
