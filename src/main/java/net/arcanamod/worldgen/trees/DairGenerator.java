...
public class DairGenerator extends WorldGenAbstractTree{
	private static final IBlockState DEFAULT_TRUNK = ArcanaBlocks.DAIR_LOG.getDefaultState();
	private static final IBlockState DEFAULT_TAINTED_TRUNK = ArcanaBlocks.TAINTED_DAIR_LOG.getDefaultState();
	private static final IBlockState DEFAULT_UNTAINTED_TRUNK = ArcanaBlocks.UNTAINTED_DAIR_LOG.getDefaultState();
	private static final IBlockState DEFAULT_LEAVES = ArcanaBlocks.DAIR_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.FALSE);
	private static final IBlockState DEFAULT_TAINTED_LEAVES = ArcanaBlocks.TAINTED_DAIR_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.FALSE);
	private static final IBlockState DEFAULT_UNTAINTED_LEAVES = ArcanaBlocks.UNTAINTED_DAIR_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.FALSE);
