...
public class FeatureGenerator
{
    ...
    /**
     * Easy Ore Feature
     * @param biome Biome where block/ore will be generated.
     * @param fillerBlockType On which block will block/ore be generated.
     * @param toGenerate Block/Ore that will be generated in the world.
     * @param rangeConfig Config about where that ore will be generated.
    ...
    {
        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, OreFeature.ORE.withConfiguration(new OreFeatureConfig(fillerBlockType, toGenerate.getDefaultState(),veinSize))
                        .withPlacement( Placement.COUNT_RANGE.configure(rangeConfig)));
    }
}