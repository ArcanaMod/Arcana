...
import net.arcanamod.util.ResearchNotes;
...
public class ArcanaItems{
	...
	public static final RegistryObject<Item> ARTIFACT_LIMESTOCK_BRICK = ITEMS.register(                        "artifact_limestock_brick", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_ANCIENT_DREAMCATCHER = ITEMS.register(              "artifact_ancient_dreamcatcher", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_ARSENOPYRITE = ITEMS.register(                              "artifact_arsenopyrite", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_BIRD_SKULL = ITEMS.register(                                  "artifact_bird_skull", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_BISMUTH = ITEMS.register(                                        "artifact_bismuth", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_BLOODSTAINED_ROCK = ITEMS.register(                    "artifact_bloodstained_rock", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.ORE));
	public static final RegistryObject<Item> ARTIFACT_BROKEN_AMULET = ITEMS.register(                            "artifact_broken_amulet", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_BROKEN_AXE_HEAD = ITEMS.register(                        "artifact_broken_axe_head", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_BROKEN_GLASS_ORB = ITEMS.register(                      "artifact_broken_glass_orb", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_BURNT_TAINT_TENDRIL = ITEMS.register(                "artifact_burnt_taint_tendril", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_CARVED_SPEARHEAD = ITEMS.register(                      "artifact_carved_spearhead", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_CAVE_FUNGUS = ITEMS.register(                                "artifact_cave_fungus", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_COMET_SHARD = ITEMS.register(                                "artifact_comet_shard", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_CRACKED_ENDERPEARL = ITEMS.register(                  "artifact_cracked_enderpearl", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.END_CITY));
	public static final RegistryObject<Item> ARTIFACT_CRUMBLING_BLACKSTONE = ITEMS.register(              "artifact_crumbling_blackstone", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_DIRTY_MAGIC_LEATHER = ITEMS.register(                "artifact_dirty_magic_leather", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_EERIE_SKULL = ITEMS.register(                                "artifact_eerie_skull", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_EMPTY_GEODE = ITEMS.register(                                "artifact_empty_geode", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.ORE));
	public static final RegistryObject<Item> ARTIFACT_EMPTY_LEATHER_BAG = ITEMS.register(                    "artifact_empty_leather_bag", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_ENCASED_INSECT = ITEMS.register(                          "artifact_encased_insect", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_ETCHED_GOLD_COIN = ITEMS.register(                      "artifact_etched_gold_coin", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.VILLAGES));
	public static final RegistryObject<Item> ARTIFACT_ETERNAL_ICE = ITEMS.register(                                "artifact_eternal_ice", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_FOSSILIZED_BARK = ITEMS.register(                        "artifact_fossilized_bark", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_GALLIUM_CHUNK = ITEMS.register(                            "artifact_gallium_chunk", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.ORE));
	public static final RegistryObject<Item> ARTIFACT_GLOWING_DIRT_CHUNK = ITEMS.register(                  "artifact_glowing_dirt_chunk", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_HARDENED_SLIME_BALL = ITEMS.register(                "artifact_hardened_slime_ball", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_HEART_RUBY = ITEMS.register(                                  "artifact_heart_ruby", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.ORE));
	public static final RegistryObject<Item> ARTIFACT_HEMATITE_CLUSTER = ITEMS.register(                      "artifact_hematite_cluster", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_IGNEOUS_ROCK = ITEMS.register(                              "artifact_igneous_rock", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.ORE));
	public static final RegistryObject<Item> ARTIFACT_MARIANA_CRYSTAL = ITEMS.register(                        "artifact_mariana_crystal", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_MONSTER_SKULL = ITEMS.register(                            "artifact_monster_skull", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_MUMMIFIED_HAND = ITEMS.register(                          "artifact_mummified_hand", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_MYSTIC_ROOT = ITEMS.register(                                "artifact_mystic_root", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_ODD_DOLL = ITEMS.register(                                      "artifact_odd_doll", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_OLD_GAUNTLET = ITEMS.register(                              "artifact_old_gauntlet", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_OLD_SCYTHE_HEAD = ITEMS.register(                        "artifact_old_scythe_head", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_OVERGROWN_REDSTONE_CRYSTAL = ITEMS.register(  "artifact_overgrown_redstone_crystal", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.ORE));
	public static final RegistryObject<Item> ARTIFACT_PENROSE_CRYSTAL = ITEMS.register(                        "artifact_penrose_crystal", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_PERFECTLY_GENERIC_ROCK = ITEMS.register(          "artifact_perfectly_generic_rock", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_PHOSPHORESCENT_STONE = ITEMS.register(              "artifact_phosphorescent_stone", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.ORE));
	public static final RegistryObject<Item> ARTIFACT_PULSATING_CRYSTAL = ITEMS.register(                    "artifact_pulsating_crystal", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_PYROCOAL = ITEMS.register(                                      "artifact_pyrocoal", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.ORE));
	public static final RegistryObject<Item> ARTIFACT_RUSTY_GEAR = ITEMS.register(                                  "artifact_rusty_gear", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_RUSTY_HAMMERHEAD = ITEMS.register(                      "artifact_rusty_hammerhead", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_RUSTY_KNIFE = ITEMS.register(                                "artifact_rusty_knife", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_RUSTY_OIL_LANTERN = ITEMS.register(                    "artifact_rusty_oil_lantern", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_SHINIEST_CROWN = ITEMS.register(                          "artifact_shiniest_crown", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.VILLAGES));
	public static final RegistryObject<Item> ARTIFACT_SOPORIFIC_INCENSE_STICK = ITEMS.register(        "artifact_soporific_incense_stick", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_SUSPICIOUS_SKULL = ITEMS.register(                      "artifact_suspicious_skull", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_THINKING_ROCK = ITEMS.register(                            "artifact_thinking_rock", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.ORE));
	public static final RegistryObject<Item> ARTIFACT_TORN_MAP = ITEMS.register(                                      "artifact_torn_map", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_TWISTED_HORN = ITEMS.register(                              "artifact_twisted_horn", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_UNNATURALLY_PERFECT_CRYSTAL = ITEMS.register("artifact_unnaturally_perfect_crystal", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.EVERYWHERE));
	public static final RegistryObject<Item> ARTIFACT_UNREFLECTIVE_OBSIDIAN_SHARD = ITEMS.register("artifact_unreflective_obsidian_shard", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.BASTIONS));
	public static final RegistryObject<Item> ARTIFACT_UNREFLECTIVE_ONYX_GEM = ITEMS.register(            "artifact_unreflective_onyx_gem", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.ORE));
	public static final RegistryObject<Item> ARTIFACT_WEATHERED_STONE = ITEMS.register(                        "artifact_weathered_stone", () -> ArtifactItem.create(ResearchNotes.empty,LootTableGroups.ORE));
}