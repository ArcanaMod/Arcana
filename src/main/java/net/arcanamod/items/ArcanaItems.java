...
public class ArcanaItems{
	...
	// Filters
	public static final RegistryObject<Item> ARCANIUM_FILTER = ITEMS.register("arcanium_filter", () -> new Item(new Properties().group(Arcana.ITEMS)));
	public static final RegistryObject<Item> SILVERWOOD_FILTER = ITEMS.register("silverwood_filter", () -> new Item(new Properties().group(Arcana.ITEMS)));
	public static final RegistryObject<Item> GREATWOOD_FILTER = ITEMS.register("greatwood_filter", () -> new Item(new Properties().group(Arcana.ITEMS)));
	public static final RegistryObject<Item> HAWTHORN_FILTER = ITEMS.register("hawthorn_filter", () -> new Item(new Properties().group(Arcana.ITEMS)));
	public static final RegistryObject<Item> DAIR_FILTER = ITEMS.register("dair_filter", () -> new Item(new Properties().group(Arcana.ITEMS)));
	public static final RegistryObject<Item> WILLOW_FILTER = ITEMS.register("willow_filter", () -> new Item(new Properties().group(Arcana.ITEMS)));
	public static final RegistryObject<Item> EUCALYPTUS_FILTER = ITEMS.register("eucalyptus_filter", () -> new Item(new Properties().group(Arcana.ITEMS)));
