...
public class ArcanaItems{
	...
	@GIM(ITEM) public static final RegistryObject<CoreItem> BONE_WAND_CORE = ITEMS.register("bone_wand_core", () -> new CoreItem(new Properties().group(Arcana.ITEMS), 100,5, 4, arcLoc("bone_wand"), new MDModifier.ReducedVis(Collections.singletonList(new AspectStack(Aspects.CHAOS,20)))));
	@GIM(ITEM) public static final RegistryObject<CoreItem> ICE_WAND_CORE = ITEMS.register("ice_wand_core", () -> new CoreItem(new Properties().group(Arcana.ITEMS), 100,10, 4, arcLoc("ice_wand"), new MDModifier.ReducedVis(Collections.singletonList(new AspectStack(Aspects.WATER,20)))));
	@GIM(ITEM) public static final RegistryObject<CoreItem> ARCANE_STONE_WAND_CORE = ITEMS.register("arcane_stone_wand_core", () -> new CoreItem(new Properties().group(Arcana.ITEMS), 100,10, 4, arcLoc("arcane_stone_wand"), new MDModifier.ReducedVis(Collections.singletonList(new AspectStack(Aspects.ORDER,20)))));
	@GIM(ITEM) public static final RegistryObject<CoreItem> OBSIDIAN_WAND_CORE = ITEMS.register("obsidian_wand_core", () -> new CoreItem(new Properties().group(Arcana.ITEMS), 100,5, 4, arcLoc("obsidian_wand"), new MDModifier.ReducedVis(Collections.singletonList(new AspectStack(Aspects.EARTH,20)))));
	@GIM(ITEM) public static final RegistryObject<CoreItem> SUGAR_CANE_WAND_CORE = ITEMS.register("sugar_cane_wand_core", () -> new CoreItem(new Properties().group(Arcana.ITEMS), 100,10, 4, arcLoc("sugar_cane_wand"), new MDModifier.ReducedVis(Collections.singletonList(new AspectStack(Aspects.AIR,20)))));
	@GIM(ITEM) public static final RegistryObject<CoreItem> MECHANICAL_WAND_CORE = ITEMS.register("mechanical_wand_core", () -> new CoreItem(new Properties().group(Arcana.ITEMS), 125,15, 4, arcLoc("mechanical_wand"), new MDModifier.Mechanical()));
	@GIM(ITEM) public static final RegistryObject<CoreItem> ELDRITCH_WAND_CORE = ITEMS.register("eldritch_wand_core", () -> new CoreItem(new Properties().group(Arcana.ITEMS), 250,30, 4, arcLoc("eldritch_wand"), new MDModifier.Warping()));
