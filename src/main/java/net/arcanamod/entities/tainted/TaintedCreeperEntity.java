...
public class TaintedCreeperEntity extends CreeperEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, TaintedEntity.class, 6.0F, 1.0D, 1.2D));
	...
	private void explode() {
		if (!this.world.isRemote) {
			...
			float f = this.func_225509_J__() ? 4.0F : 2.0F;
			this.dead = true;
