	...
	public void tick() {
		...
		if (world.isRemote) {
			...
			if (currRadius < getRadius()) {
				List<LivingEntity> entities = world.getEntitiesWithinAABB(LivingEntity.class, new AxisAlignedBB(-currRadius/2f,-currRadius/2f,-currRadius/2f,currRadius/2f,currRadius/2f,currRadius/2f), LivingEntity::isAlive);
