...
public class DairSpiritEntity extends FlyingEntity implements IFlyingAnimal{
	...
	public DairSpiritEntity(EntityType<? extends DairSpiritEntity> type, World world){
		super(type, world);
		experienceValue = 5;
		moveController = new DairSpiritEntity.MoveHelperController(this);
	}
	
	@Override
	protected void registerGoals(){
		super.registerGoals();
		goalSelector.addGoal(5, new DairSpiritEntity.RandomFlyGoal(this));
		goalSelector.addGoal(7, new DairSpiritEntity.LookAroundGoal(this));
	}
