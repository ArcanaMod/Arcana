...
public class ArcanaBlocks{
	...
	public static final RegistryObject<Block> ARCANE_STONE = BLOCKS.register("arcane_stone", () -> new GroupedBlock(create(ROCK), Arcana.ITEMS));
	...
	public static final RegistryObject<Block> ARCANE_STONE_BRICKS = BLOCKS.register("arcane_stone_bricks", () -> new GroupedBlock(create(ROCK), Arcana.ITEMS));
	...
	public static final RegistryObject<Block> AMBER_ORE = BLOCKS.register("amber_ore", () -> new GroupedBlock(create(ROCK), Arcana.ITEMS));
	...
	public static final RegistryObject<Block> INFUSION_ARCANE_STONE = BLOCKS.register("infusion_arcane_stone", () -> new GroupedBlock(create(ROCK), Arcana.ITEMS));
	//	public static final Block MAGICAL_GRASS = new BlockBase("magical_grass", Material.GRASS).setCreativeTab(Arcana.TAB_ARCANA);
	public static final RegistryObject<Block> MAGICAL_GRASS = BLOCKS.register("magical_grass", () -> new GroupedBlock(create(Material.ORGANIC), Arcana.ITEMS));
	...
	//
	//	// Tainted General
	//	public static final Block TAINTED_CRUST = new TaintedBlockBase("tainted_crust", ROCK);
	...
	//	public static final Block TAINTED_ROCK = new TaintedBlockBase("tainted_rock", ROCK);
	...
	//
	//	// Tainted Ore
	//	public static final Block TAINTED_AMBER_ORE = new TaintedBlockBase("tainted_amber_ore", ROCK);
	//	public static final Block TAINTED_ARCANIUM_ORE = new TaintedBlockBase("tainted_arcanium_ore", ROCK);
	//	public static final Block TAINTED_CINNABAR_ORE = new TaintedBlockBase("tainted_cinnabar_ore", ROCK);
	//	public static final Block TAINTED_COAL_ORE = new TaintedBlockBase("tainted_coal_ore", ROCK);
	//	public static final Block TAINTED_DESTROYED_ORE = new TaintedBlockBase("tainted_destroyed_ore", ROCK);
	//	public static final Block TAINTED_DIAMOND_ORE = new TaintedBlockBase("tainted_diamond_ore", ROCK);
	//	public static final Block TAINTED_EMERALD_ORE = new TaintedBlockBase("tainted_emerald_ore", ROCK);
	//	public static final Block TAINTED_GOLD_ORE = new TaintedBlockBase("tainted_gold_ore", ROCK);
	//	public static final Block TAINTED_IRON_ORE = new TaintedBlockBase("tainted_iron_ore", ROCK);
	//	public static final Block TAINTED_LAPIS_ORE = new TaintedBlockBase("tainted_lapis_ore", ROCK);
	//	public static final Block TAINTED_REDSTONE_ORE = new TaintedBlockBase("tainted_redstone_ore", ROCK);
	//	public static final Block TAINTED_RUBY_ORE = new TaintedBlockBase("tainted_ruby_ore", ROCK);
	//	public static final Block TAINTED_SILVER_ORE = new TaintedBlockBase("tainted_silver_ore", ROCK);
	//
	//	// Tainted Wood
	...
	//
	//	// Untainted General
	//	public static final Block UNTAINTED_CRUST = new TaintedBlockBase("untainted_crust", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	...
	//	public static final Block UNTAINTED_ROCK = new TaintedBlockBase("untainted_rock", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	...
	//
	//	// Untainted Ore
	//	public static final Block UNTAINTED_AMBER_ORE = new TaintedBlockBase("untainted_amber_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_ARCANIUM_ORE = new TaintedBlockBase("untainted_arcanium_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_CINNABAR_ORE = new TaintedBlockBase("untainted_cinnabar_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_COAL_ORE = new TaintedBlockBase("untainted_coal_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_DESTROYED_ORE = new TaintedBlockBase("untainted_destroyed_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_DIAMOND_ORE = new TaintedBlockBase("untainted_diamond_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_EMERALD_ORE = new TaintedBlockBase("untainted_emerald_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_GOLD_ORE = new TaintedBlockBase("untainted_gold_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_IRON_ORE = new TaintedBlockBase("untainted_iron_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_LAPIS_ORE = new TaintedBlockBase("untainted_lapis_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_REDSTONE_ORE = new TaintedBlockBase("untainted_redstone_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_RUBY_ORE = new TaintedBlockBase("untainted_ruby_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//	public static final Block UNTAINTED_SILVER_ORE = new TaintedBlockBase("untainted_silver_ore", ROCK).setCreativeTab(Arcana.TAB_TAINTARCANA);
	//
	//	// Untainted Wood
