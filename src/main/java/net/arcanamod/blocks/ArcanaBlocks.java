...
public class ArcanaBlocks{
	...
	public static final RegistryObject<Block> ASPECT_BOOKSHELF = BLOCKS.register("aspect_bookshelf", () -> new AspectBookshelfBlock(false, create(WOOD).hardnessAndResistance(6)));
	public static final RegistryObject<Block> ASPECT_BOOKSHELF_BLOCK = BLOCKS.register("aspect_bookshelf_block", () -> new AspectBookshelfBlock(true, create(WOOD).hardnessAndResistance(6)));
