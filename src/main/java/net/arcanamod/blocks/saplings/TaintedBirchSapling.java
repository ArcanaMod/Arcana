...
public class TaintedBirchSapling extends SaplingBase{
	...
	public void generateTree(World worldIn, BlockPos pos, BlockState state, Random rand){
		...
		Feature worldgenerator = untainted ? new TaintedBirchGenerator(true, useExtraRandomHeight, true, true) : new TaintedBirchGenerator(true, useExtraRandomHeight, true, false);
