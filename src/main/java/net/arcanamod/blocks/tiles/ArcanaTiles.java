...
public class ArcanaTiles{
	...
	public static final RegistryObject<TileEntityType<QuaesitumTileEntity>> QUAESITUM_TE =
			TES.register("quaesitum", () -> new TileEntityType<>(QuaesitumTileEntity::new, Sets.newHashSet(ArcanaBlocks.ARCHEOLOGY_TABLE.get()), null));
}