...
public class ArcanaTiles{
	...
	public static final RegistryObject<TileEntityType<NodeTileEntity>> NODE_TE =
			TES.register("node", () -> new TileEntityType<>(NodeTileEntity::new, Sets.newHashSet(ArcanaBlocks.NORMAL_NODE.get()), null));
