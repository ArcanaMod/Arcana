...
public class ArcanaDevOptionsScreen extends Screen{
	...
	@Override
	protected void init(){
		buttons.add(new Button(this.width / 2 - 102, this.height / 4 + 24 + -16, 204, 20, I18n.format("devtools.arcana_book_editmode"), b -> Arcana.proxy.openResearchBookUI(new ResourceLocation(MODID, "arcanum"), this)));
