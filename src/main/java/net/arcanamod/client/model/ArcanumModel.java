...
public class ArcanumModel extends Model {
	private final ModelRenderer coverRight = (new ModelRenderer(48, 48, 27, 21)).addBox(-4.0F, -4.0F, 0F, 9.0F, 12.0F, 1.0F);
	...
	public void func_228247_a_(float p_228247_1_, float p_228247_2_, float p_228247_3_, float p_228247_4_) {
		float f = (MathHelper.sin(p_228247_1_ * ArcanaVariables.f0) * ArcanaVariables.f1 + ArcanaVariables.f2) * p_228247_4_;
