...
public class TaintedBatModel extends SegmentedModel<TaintedBatEntity> {
	 ...
	 */
	public void setRotationAngles(TaintedBatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
