...
public class AspectCombosSectionRenderer implements EntrySectionRenderer<AspectCombosSection>{
	...
	public void render(AspectCombosSection section, int pageIndex, int screenWidth, int screenHeight, int mouseX, int mouseY, boolean right, PlayerEntity player){
	...
	public void renderAfter(AspectCombosSection section, int pageIndex, int screenWidth, int screenHeight, int mouseX, int mouseY, boolean right, PlayerEntity player){
		int x = (right ? PAGE_X + RIGHT_X_OFFSET : PAGE_X) + (screenWidth - 256) / 2 + 4;
		int y = PAGE_Y + (screenHeight - 181) / 2 + HEIGHT_OFFSET + 10;
