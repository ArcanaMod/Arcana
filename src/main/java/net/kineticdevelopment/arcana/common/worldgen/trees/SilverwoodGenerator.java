...
public class SilverwoodGenerator extends WorldGenAbstractTree {
    private final IBlockState metaWood = BlockInit.SILVERWOOD_LOG.getDefaultState();;
    private final IBlockState metaLeaves = BlockInit.SILVERWOOD_LEAVES.getDefaultState();;
