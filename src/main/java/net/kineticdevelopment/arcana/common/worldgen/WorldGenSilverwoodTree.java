...
{
	private IBlockState blockStateWood = blockinit.SILVERWOODLOG.getDefaultState();
    private IBlockState blockStateLeaves = blockinit.SILVERWOODLEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
