...
{
	private IBlockState blockStateWood = blockinit.TAINTEDLOG.getDefaultState();
    private IBlockState blockStateLeaves = blockinit.TAINTEDLEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    private final int minTreeHeight = 4;

    public WorldGenTaintedTree(boolean notify)
    {
        super(notify);
    }
