...
public class SilverwoodLeaves extends BlockLeaves implements IHasModel
{
	...
	public SilverwoodLeaves(String name, Material material) 
	{
		super();
    ...
    {
        return Item.getItemFromBlock(blockinit.SILVERWOODSAPLING);
    }
