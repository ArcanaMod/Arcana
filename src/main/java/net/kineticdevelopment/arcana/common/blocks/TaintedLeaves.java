...
public class TaintedLeaves extends BlockLeaves implements IHasModel
{
	...
	public TaintedLeaves(String name, Material material) 
	{
		super();
    ...
    {
        return Item.getItemFromBlock(blockinit.TAINTEDSAPLING);
    }
